...
import { Info, ExternalLink, Building2, Users } from 'lucide-react';
...
export function CopilotSettingsTab() {
  ...
  const { enabledCopilotModels, toggleCopilotModel } = useAppStore();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-purple-500/10 border border-purple-500/20">
        ...
        <div className="text-sm text-purple-400/90 flex-1">
          <span className="font-medium">Optional Provider</span>
          <p className="text-xs text-purple-400/70 mt-1">
            GitHub Copilot provides access to multiple AI models including GPT-5, Claude Sonnet 4,
            Gemini 2.5 Pro, and more through your GitHub account.
          </p>
        </div>
      </div>
